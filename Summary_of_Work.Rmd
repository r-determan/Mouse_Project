...
zero_rule_acc <- ifelse(sum(testing$open == 0)>sum(testing$open == 1), sum(testing$open == 0)/nrow(testing),  sum(testing$open == 1)/nrow(testing))
all_results <- rbind(all_results, data.frame(model_name = "Logistic Reg w/ PCA",
                                             zero_rule_acc = zero_rule_acc,
                                             model_acc = 1-error_rate))
...
zero_rule_acc <- ifelse(sum(y_test == 0)>sum(y_test == 1), sum(y_test== 0)/nrow(y_test),  sum(y_test == 1)/nrow(y_test))
all_results <- rbind(all_results, data.frame(model_name = "Simple Neural Net",
                                             zero_rule_acc = zero_rule_acc,
...
all_results <- rbind(all_results, data.frame(model_name = "Incorrect RNN",
                                             zero_rule_acc = zero_rule_acc,
                                             model_acc = sum(result$true == result$pred)/nrow(result)))
...
zero_rule_acc <- ifelse(sum(result$true == 0)>sum(result$true == 1), 
                        sum(result$true == 0)/nrow(result),  
                        sum(result$true == 1)/nrow(result))
all_results <- rbind(all_results, data.frame(model_name = "Correct RNN w/ 25 neurons",
                                             zero_rule_acc = zero_rule_acc,
                                             model_acc = sum(result$true == result$pred)/nrow(result)))
...
zero_rule_acc <- ifelse(sum(result$true == 0)>sum(result$true == 1), 
                        sum(result$true == 0)/nrow(result),  
                        sum(result$true == 1)/nrow(result))
all_results <- rbind(all_results, data.frame(model_name = "Correct RNN w/ all neurons",
                                             zero_rule_acc = zero_rule_acc,
                                             model_acc = sum(result$true == result$pred)/nrow(result)))
