...
ggplot(data = all_mice_bdlstm,aes(x = model_name))+
  ...
  geom_point(aes(y = model_acc, color = "Model Accuracy"), size = 13)+
  geom_point(aes(y = zero_rule_acc, color = "Zero Rule Accuracy"), size = 13)+
...
ggplot(data = acc,aes(x = mouse_id))+
  ...
  geom_point(aes(y = accuracy, color = "Model Accuracy"), size = 13)+
  geom_point(aes(y = larger_class, color = "Zero Rule Accuracy"), size = 13)+
